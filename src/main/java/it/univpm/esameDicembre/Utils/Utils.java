...
/**
 * Libreria di metodi statici utilizzati all'avvio del programma.
 * Decodifica JSON, download del dataset e parsing dei dati.
 * 
...
public class Utils {
	...
	/**
	 * Effettua la decodifica di una pagina codificata in JSON, ne ricava
	 * l'URL contenente il dataset e ne effettua il download.
	 * @param url URL della pagina JSON da decodificare.
	...
	/**
	 * Metodo utilizzato da {@link JSONDecode} per effettuare il download e 
	 * il salvataggio nella directory (se il file da scaricare è gia contenuto
	 * nella directory, viene sostituito).
	 * @param url URL della pagina JSON da decodificare.
	 * @param fileName File che contiene il dataset.
	 * @throws Exception
	 */
	 ...
	 * @param data ArrayList in cui vengono salvati gli elementi del dataset. 
	 * @param header ArrayList in cui vengono salvati i metadati del dataset (prima riga del file).
	 * @param fileName File che contiene il dataset.
	 * @throws IOException
	 */
	public static void tsvParse(ArrayList<Element> data, ArrayList<Metadata> header, String fileName) throws IOException {
